								...
								<tr id="yith-wcwl-row-<?php polo_render($item['prod_id']) ?>" data-row-id="<?php polo_render($item['prod_id']) ?>">
									...
									<?php if ( $is_user_owner ): ?>
										<td class="product-remove">
											<div>
												<a href="<?php echo esc_url( add_query_arg( 'remove_from_wishlist', $item['prod_id'] ) ) ?>" class="remove_from_wishlist" title="<?php esc_attr_e( 'Remove this product', 'polo' ) ?>"><i class="fa fa-times"></i></a>
											</div>
										</td>
									<?php endif; ?>
									...
									<td class="cart-product-thumbnail">
										...
										<div class="cart-product-thumbnail-name"><?php echo esc_html( $product->get_title() ); ?></div>
									</td>

									<td class="cart-product-description">
										<p><?php echo esc_ahtml(wp_trim_words($product->post->post_excerpt,'20',''));?></p>
									...
									<?php if ( $show_last_column ): ?>
										<td class="cart-product-add-to-cart">
											...
											<?php if ( $is_user_owner && $repeat_remove_button ): ?>
												<a href="<?php echo esc_url( add_query_arg( 'remove_from_wishlist', $item['prod_id'] ) ) ?>" class="remove_from_wishlist button" title="<?php esc_attr_e( 'Remove this product', 'polo' ) ?>"><?php esc_html_e( 'Remove', 'polo' ) ?></a>
											<?php endif; ?>
										</td>
									<?php endif; ?>
								</tr>
