  ...
  class CSF_Field_repeater extends CSF_Fields {
    ...
    public function render() {
      ...
      if ( preg_match( '/'. preg_quote( '['. $this->field['id'] .']' ) .'/', $this->unique ) ) {
        ...
        echo '<i class="csf-repeater-remove csf-confirm fas fa-times" data-confirm="'. esc_html__( 'Are you sure to delete this item?', 'polo' ) .'"></i>';
        echo '</div>';
        echo '</div>';
        echo '</div>';
        ...
        echo '<div class="csf-repeater-alert csf-repeater-max">'. esc_html__( 'You cannot add more.', 'polo' ) .'</div>';
        echo '<div class="csf-repeater-alert csf-repeater-min">'. esc_html__( 'You cannot remove more.', 'polo' ) .'</div>';
