      ...
      echo '<div class="csf--typography'. esc_attr( $chosen_class ) .'" data-unit="'. esc_attr( $args['unit'] ) .'" data-line-height-unit="'. esc_attr( $line_height_unit ) .'" data-exclude="'. esc_attr( $args['exclude'] ) .'">';
        ...
        echo '<div class="csf--blocks csf--blocks-selects">';
          ...
          if ( ! empty( $args['font_family'] ) ) {
            ...
            echo '<div class="csf--title">'. esc_html__( 'Font Family', 'polo' ) .'</div>';
            echo '' . $this->create_select( array( $this->value['font-family'] => $this->value['font-family'] ), 'font-family', esc_html__( 'Select a font', 'polo' ) );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['backup_font_family'] ) ) {
            ...
            echo '<div class="csf--title">'. esc_html__( 'Backup Font Family', 'polo' ) .'</div>';
            echo '' . $this->create_select( apply_filters( 'csf_field_typography_backup_font_family', array(
              ...
              'Georgia, serif',
              'Palatino Linotype'
            ) ), 'backup-font-family', esc_html__( 'Default', 'polo' ) );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['font_weight'] ) || ! empty( $args['font_style'] ) ) {
            ...
            echo '<div class="csf--title">'. esc_html__( 'Font Style', 'polo') .'</div>';
            echo '<select class="csf--font-style-select" data-placeholder="Default">';
            echo '<option value="">'. ( ! $this->chosen ? esc_html__( 'Default', 'polo' ) : '' ) .'</option>';
            ...
            if ( ! empty( $args['extra_styles'] ) ) {
              ...
              echo ( ! $this->chosen ) ? '<div class="csf--title">'. esc_html__( 'Load Extra Styles', 'polo' ) .'</div>' : '';
              $placeholder = ( $this->chosen ) ? esc_html__( 'Load Extra Styles', 'polo' ) : esc_html__( 'Default', 'polo' );
          ...
          if ( ! empty( $args['subset'] ) ) {
            ...
            echo '<div class="csf--title">'. esc_html__( 'Subset', 'polo' ) .'</div>';
            $subset = ( is_array( $this->value['subset'] ) ) ? $this->value['subset'] : array_filter( (array) $this->value['subset'] );
            echo '' . $this->create_select( $subset, 'subset', esc_html__( 'Default', 'polo' ), $args['multi_subset'] );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['text_align'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Text Align', 'polo' ) .'</div>';
            echo '' . $this->create_select( array(
              'inherit' => esc_html__( 'Inherit', 'polo' ),
              'left'    => esc_html__( 'Left', 'polo' ),
              'center'  => esc_html__( 'Center', 'polo' ),
              'right'   => esc_html__( 'Right', 'polo' ),
              'justify' => esc_html__( 'Justify', 'polo' ),
              'initial' => esc_html__( 'Initial', 'polo' )
            ), 'text-align', esc_html__( 'Default', 'polo' ) );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['font_variant'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Font Variant', 'polo' ) .'</div>';
            echo '' . $this->create_select( array(
              'normal'         => esc_html__( 'Normal', 'polo' ),
              'small-caps'     => esc_html__( 'Small Caps', 'polo' ),
              'all-small-caps' => esc_html__( 'All Small Caps', 'polo' )
            ), 'font-variant', esc_html__( 'Default', 'polo' ) );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['text_transform'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Text Transform', 'polo' ) .'</div>';
            echo '' . $this->create_select( array(
              'none'       => esc_html__( 'None', 'polo' ),
              'capitalize' => esc_html__( 'Capitalize', 'polo' ),
              'uppercase'  => esc_html__( 'Uppercase', 'polo' ),
              'lowercase'  => esc_html__( 'Lowercase', 'polo' )
            ), 'text-transform', esc_html__( 'Default', 'polo' ) );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['text_decoration'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Text Decoration', 'polo' ) .'</div>';
            echo '' . $this->create_select( array(
              'none'               => esc_html__( 'None', 'polo' ),
              'underline'          => esc_html__( 'Solid', 'polo' ),
              'underline double'   => esc_html__( 'Double', 'polo' ),
              'underline dotted'   => esc_html__( 'Dotted', 'polo' ),
              'underline dashed'   => esc_html__( 'Dashed', 'polo' ),
              'underline wavy'     => esc_html__( 'Wavy', 'polo' ),
              'underline overline' => esc_html__( 'Overline', 'polo' ),
              'line-through'       => esc_html__( 'Line-through', 'polo' )
            ), 'text-decoration', esc_html__( 'Default', 'polo' ) );
            echo '</div>';
          }
        ...
        echo '<div class="csf--blocks csf--blocks-inputs">';
          ...
          if ( ! empty( $args['font_size'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Font Size', 'polo' ) .'</div>';
          ...
          if ( ! empty( $args['line_height'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Line Height', 'polo' ) .'</div>';
            echo '<div class="csf--input-wrap">';
          ...
          if ( ! empty( $args['letter_spacing'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Letter Spacing', 'polo' ) .'</div>';
            echo '<div class="csf--input-wrap">';
          ...
          if ( ! empty( $args['word_spacing'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Word Spacing', 'polo' ) .'</div>';
            echo '<div class="csf--input-wrap">';
        ...
        if ( ! empty( $args['color'] ) ) {
          ...
          echo '<div class="csf--title">'. esc_html__( 'Font Color', 'polo' ) .'</div>';
        ...
        if ( ! empty( $args['custom_style'] ) ) {
          ...
          echo '<div class="csf--title">'. esc_html__( 'Custom Style', 'polo' ) .'</div>';
      ...
      if ( ! wp_script_is( 'csf-webfontloader' ) ) {
        ...
        if ( ! empty( $customwebfonts ) ) {
          $webfonts['custom'] = array(
            'label' => esc_html__( 'Custom Web Fonts', 'polo' ),
            'fonts' => $customwebfonts
          );
        }

        $webfonts['safe'] = array(
          'label' => esc_html__( 'Safe Web Fonts', 'polo' ),
        ...
        $webfonts['google'] = array(
          'label' => esc_html__( 'Google Web Fonts', 'polo' ),
