  ...
  class CSF_Field_border extends CSF_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        ...
        'top_placeholder'    => esc_html__( 'top', 'polo' ),
        'right_placeholder'  => esc_html__( 'right', 'polo' ),
        'bottom_placeholder' => esc_html__( 'bottom', 'polo' ),
        'left_placeholder'   => esc_html__( 'left', 'polo' ),
        'all_placeholder'    => esc_html__( 'all', 'polo' ),
        'top'                => true,
        'left'               => true,
        'bottom'             => true,
        'right'              => true,
      ...
      $border_props = array(
        'solid'     => esc_html__( 'Solid', 'polo' ),
        'dashed'    => esc_html__( 'Dashed', 'polo' ),
        'dotted'    => esc_html__( 'Dotted', 'polo' ),
        'double'    => esc_html__( 'Double', 'polo' ),
        'inset'     => esc_html__( 'Inset', 'polo' ),
        'outset'    => esc_html__( 'Outset', 'polo' ),
        'groove'    => esc_html__( 'Groove', 'polo' ),
        'ridge'     => esc_html__( 'ridge', 'polo' ),
