  ...
  class CSF_Field_media extends CSF_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        ...
        'preview'      => true,
        'library'      => array(),
        'button_title' => esc_html__( 'Upload', 'polo' ),
        'remove_title' => esc_html__( 'Remove', 'polo' ),
      ...
      $placeholder = ( empty( $this->field['placeholder'] ) ) ? ' placeholder="'.  esc_html__( 'Not selected', 'polo' ) .'"' : '';
