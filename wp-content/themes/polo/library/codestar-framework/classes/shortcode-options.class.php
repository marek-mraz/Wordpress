  ...
  class CSF_Shortcoder extends CSF_Abstract{
          ...
          <div class="csf-modal-table-cell">
            ...
            <div class="csf-modal-inner">
              ...
              <?php
                ...
                echo '<select>';
                if( $has_select ){
                  echo '<option value="">'. esc_attr( $this->args['select_title'] ) .'</option>';
                }
      ...
      if ( ! empty( $shortcode_key ) && wp_verify_nonce( $nonce, 'csf_shortcode_nonce' ) ) {
        ...
        if ( ! empty( $section ) ) {
          ...
          if ( ! empty( $repeatable_fields ) ) {
            ...
            $button_title    = ( ! empty( $section['button_title'] ) ) ? ' '. $section['button_title'] : esc_html__( 'Add New', 'polo' );
        ...
        echo '<div class="csf-field csf-error-text">'. esc_html__( 'Error: Invalid nonce verification.', 'polo' ) .'</div>';
      }
    ...
    public static function add_guteberg_blocks() {
      ...
      foreach ( CSF::$shortcode_instances as $value ) {
        $f = 'register' . '_block_type';
        $f( 'csf-gutenberg-block/block-'. $value['hash'], array(
