  ...
  class CSF {
    ...
    public static function add_admin_enqueue_scripts() {
      ...
      if ( apply_filters( 'csf_fa4', false ) ) {
        ...
        $cdn = esc_url('//cdn.'.'jsdelivr.net/');
        wp_enqueue_style( 'csf-fa5', $cdn . 'npm/@fortawesome/fontawesome-free@5.15.1/css/all'. $min .'.css', array(), '5.14.0', 'all' );
        wp_enqueue_style( 'csf-fa5-v4-shims', $cdn . 'npm/@fortawesome/fontawesome-free@5.15.1/css/v4-shims'. $min .'.css', array(), '5.14.0', 'all' );
      }
      ...
      wp_localize_script( 'csf', 'csf_vars', array(
        ...
        'i18n'              => array(
          'confirm'         => esc_html__( 'Are you sure?', 'polo' ),
          'typing_text'     => esc_html__( 'Please enter %s or more characters', 'polo' ),
          'searching_text'  => esc_html__( 'Searching...', 'polo' ),
          'no_results_text' => esc_html__( 'No results found.', 'polo' ),
        ),
      ) );
    ...
    public static function field( $field = array(), $value = '', $unique = '', $where = '', $parent = '' ) {
      ...
      if ( ! empty( $field['_notice'] ) ) {
        ...
        $field            = array();
        $field['content'] = esc_html__( 'Oops! Not allowed.', 'polo' ) .' <strong>('. $field_type .')</strong>';
        $field['type']    = 'notice';
        $field['style']   = 'danger';
      ...
      if ( ! empty( $field_type ) ) {
        ...
        if ( class_exists( $classname ) ) {
          ...
          echo '<p>'. esc_html__( 'Field not found!', 'polo' ) .'</p>';
        }
