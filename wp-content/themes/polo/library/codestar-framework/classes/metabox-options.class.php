        ...
        echo '<div class="csf-wrapper'. esc_attr( $show_all ) .'">';
          ...
          echo '<div class="csf-content">';
            ...
            foreach ( $this->sections as $section ) {
              ...
              $section_st = ( $section_title || $section_icon ) ? '<div class="csf-section-title"><h3>'. $section_icon . $section_title .'</h3></div>' : '';
              if($section_st != ''){
                echo wp_kses($section_st, array(
                  'div' => array(
                    'class' => true
                  ),
                  'i' => array(
            ...
            if ( ! empty( $this->args['show_restore'] ) || ! empty( $this->args['show_reset'] ) ) {
              ...
              echo '<span class="button csf-button-reset">'. esc_html__( 'Reset', 'polo' ) .'</span>';
              echo '<span class="button csf-button-cancel">'. sprintf( '<small>( %s )</small> %s', esc_html__( 'update post', 'polo' ), esc_html__( 'Cancel', 'polo' ) ) .'</span>';
              echo '</label>';
              echo '</div>';
