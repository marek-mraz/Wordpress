...
require_once POLO_ROOT_PATH .'/cs-framework-override/config/framework.config.php';
require_once POLO_ROOT_PATH .'/cs-framework-override/config/metabox.config.php';