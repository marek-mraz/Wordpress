			...
			default :
				...
				?>
					...
					<a class="pull-left" href="<?php echo esc_url( $user_url ) ?>">
						<?php
						$avatar_output = get_avatar( $comment, 65 );
					...
					<div class="media-body">
						...
						<h4 class="media-heading"><?php echo esc_html( $author_name ); ?></h4>

						<span class="time"><?php echo get_comment_time( 'M d, Y \a\t g:i A', false, true ); ?></span>

						<?php
						$comment_reply_link = '';
						ob_start();
						comment_reply_link( array_merge( $args, array(
							'reply_text' => ''.esc_html__('Reply','polo'),
							'before'     => '',
							'after'      => '',
							'depth'      => $depth,
						...
						$comment_reply_link = str_replace( 'comment-reply-link', 'comment-reply', $comment_reply_link );
