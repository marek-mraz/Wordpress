...
if( class_exists( 'CSF' ) ) {
    ...
    $soc_networks_array = array(
        ...
        "x-twitter"    => esc_html__( 'Twitter', 'polo' ),
        "threads"      => esc_html__( 'Threads', 'polo' ),
    ...
    CSF::createSection( $prefix, array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'type'       => 'switcher',
                'default'    => true,
                'title'      => esc_html__( 'Home icon', 'polo' ),
                'desc'       => esc_html__( 'Icon with link to home page in the menu', 'polo' ),
                'dependency' => array(
                    'header_style_select',
                    '==',
                    'standard'
    ...
    CSF::createSection( $prefix, array(
        ...
        'fields' => array(
            ...
            array(
                'id'         => 'post_date_format',
                'type'       => 'select',
                'title'      => esc_html__( 'Post date format', 'polo' ),
                'options'    => array(
                    'date' => esc_html__( 'Date', 'polo' ),
                    'relative_time' => esc_html__( 'Relative time', 'polo' ),
                ),
                'default'    => 'date',
            ),
            array(
    ...
    CSF::createSection( $prefix, array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'default'    => 'sidebar-3-column',
                'dependency' => array( 'page-main-sidebar', '!=', '1col-fixed' ),
            ),
            array(
    ...
    CSF::createSection( $prefix, array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'default'    => 'sidebar-3-column',
                'dependency' => array( 'portfolio-main-sidebar', '!=', '1col-fixed' ),
            ),
            array(
    ...
    CSF::createSection( $prefix, array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'default'    => 'sidebar-3-column',
                'dependency' => array( 'search-main-sidebar', '!=', '1col-fixed' ),
            ),
            array(
    ...
    CSF::createSection( $prefix, array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'default'    => 'sidebar-3-column',
                'dependency' => array( 'archive-main-sidebar', '!=', '1col-fixed' ),
            ),
            array(
    ...
    CSF::createSection( $prefix, array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'default'    => false,
                'dependency' => array( 'shop-main-sidebar', '==', '1col-fixed' ),
                'sanitize' => 'cs_sanitize_switcher'
            ),
            array(
                'type'    => 'heading',
    ...
    CSF::createSection( $prefix, array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'default'    => 'style_1',
                'radio'      => true,
                'dependency' => array( 'pan_style', 'any', 'style_0,style_1,style_2' ),
            ),
            array(
    ...
    * */
    ...
    // Menu Icon
    $prefix_n = '_crum_mega_menu_options';

    // Create profile options
    CSF::createNavMenuOptions( $prefix_n, array(
        'data_type' => 'serialize', // The type of the database save options. `serialize` or `unserialize`
    ) );

    // Create a section
    CSF::createSection( $prefix_n, array(
        'fields' => array(
            array(
                'id'    => 'icon',
                'type'  => 'icon',
