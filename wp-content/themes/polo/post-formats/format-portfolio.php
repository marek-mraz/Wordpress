...
<div class="portfolio-item <?php echo esc_attr( $categories_class . ' ' . $add_class ); ?>">
	<?php if ( 'default' === $hover_style || 'classic' === $hover_style ) { ?>
		<div class="portfolio-image effect effect-default">
            <?php if ('classic' === $hover_style){ ?> <a href="<?php echo esc_url( get_the_permalink( get_the_ID() ) ); ?>"><?php } ?>
			<img src="<?php echo esc_url( $image_url ) ?>" alt="<?php echo esc_attr( get_the_title() ); ?>">
            <?php if ('classic' === $hover_style){ ?> </a> <?php } else { ?>
		...
		<?php if ( true === $show_title ) { ?>
			...
			<div class="portfolio-date">
				<p class="small"><i class="fa fa-calendar-o"></i><?php echo esc_html( get_the_date( '', get_the_ID() ) ); ?></p>
			</div>
		<?php } ?>
